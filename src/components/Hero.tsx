    ...
    <section className="relative w-full h-screen min-h-[600px] max-h-[860px] overflow-hidden bg-[#0a0603] flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto">
        ...
        >
          <Link
            href="/menu-items"
            className="group inline-flex items-center gap-2.5 bg-[#c47c30] hover:bg-[#d4892f] text-white font-bold text-[12px] tracking-[0.15em] uppercase px-8 py-4 rounded-full transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] shadow-lg shadow-[#c47c30]/25"
          >
            View Menu
            <ArrowRight
              size={14}
          ...
          <Link
            href="/contact"
            className="group inline-flex items-center gap-2.5 font-bold text-[12px] tracking-[0.15em] uppercase px-8 py-4 rounded-full transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] border border-white/20 hover:border-[#c47c30]/50 text-[#f5ede0]/80 hover:text-[#ed7e07]"
          >
            Contact Us
          </Link>
        </motion.div>
